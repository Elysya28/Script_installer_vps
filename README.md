...
# Direkomendasikan menggunakan Debian 11/12 , Untuk ubuntu di coba aja, karena gak pernah ngetest..
  ...
  ```html
wget -O install.sh https://raw.githubusercontent.com/Elysya28/Script_installer_vps/tes/install.sh; chmod +x install.sh; ./install.sh; sed -i 's/\r$//' /root/trojan-manager/*.sh; /root/trojan-manager/main.sh
 ```
